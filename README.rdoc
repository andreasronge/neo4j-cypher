...
* {Neo4j Wiki Cypher}[https://github.com/andreasronge/neo4j/wiki/Neo4j::Core-Cypher]
...
*My Answer* Better readablity for (ruby) programmers, which means easier to understand and write queries.

=== Is the neo4j-cypher DSL more readable ?
